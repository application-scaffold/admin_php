<?php !defined('install') && exit(); ?>
                ...
                <div class="mounted-container" id="tab">
                    ...
                    <?php if ($step == '1') { ?>
                        <div class="mounted-content-item show">
                            ...
                            <div class="content">
                                <h2>admin_php应用授权协议</h2>
                                <div class="white-space;pre">

                                </div>

                                <p class="mt16">
                                    admin_php在此特别提醒您（用户）在订阅使用admin_php软件系统（以下简称“应用”）之前，请认真阅读本《admin_php应用授权协议》（以下简称“协议”），确保您充分理解本协议中各条款。请您审慎阅读并选择接受或不接受本协议。除非您接受本协议所有条款，否则您无权注册、登录、购买或使用本协议所涉服务。您的注册、登录、购买、使用等行为将视为对本协议的接受，并同意接受本协议各项条款的约束。
                                </p>
                                <p class="mt16">
                                    本协议约定admin_php官网与用户之间的权利义务。“用户”是指注册、登录、订阅或使用admin_php应用的个人或企业。本协议可由admin_php官网随时更新，更新后的协议条款一旦公布即代替原来的协议条款，不再另行通知，用户可在本网站查阅最新版协议条款。在admin_php官网修改协议条款后，如果用户不接受修改后的条款，请立即停止使用admin_php官网提供的服务，用户继续使用admin_php官网提供的服务将被视为接受修改后的协议。
                                </p>
                                <h3 class="mt16">一、订阅应用</h3>
                                <p class="mt16">
                                    1、用户可以在admin_php官网在线订阅admin_php付费应用，购买时需提前注册好admin_php官网账号。
                                    <br>
                                    2、用户以admin_php官网允许的支付方式订阅admin_php付费应用时，用户应当是具备完全民事权利能力和完全民事行为能力的自然人、法人或其他组织。若用户不具备前述主体资格，则用户及用户的监护人应承担因此而导致的一切后果，同时admin_php官网将保留追究用户及其监护人民事、刑事责任等权利，且admin_php官网有权注销(永久冻结)用户的admin_php官网帐号，并有权向用户及用户的监护人索赔。
                                    <br>
                                    3、用户应当在订阅使用admin_php付费应用之前认真阅读全部协议内容。用户确认admin_php官网对协议中所含免除或限制其责任的条款已尽提示、说明义务，用户同意此等条款，用户如对协议内容有任何异议的，应向admin_php官网咨询。但无论用户事实上是否在订阅或使用admin_php付费应用之前认真阅读了本协议内容，只要用户订阅或使用admin_php付费应用，即与admin_php官网缔结了本协议，本协议即对用户产生约束，届时用户不应以未阅读本协议的内容或者未获得admin_php官网对用户问询的解答等理由，主张本协议无效或要求撤销本协议。
                                    <br>
                                    4、用户承诺接受并遵守本协议的约定。如果用户不同意本协议的约定，应立即停止购买使用admin_php付费应用。
                                    <br>
                                    5、admin_php官网有权根据需要不时地制订、修改本协议或各类规则，并以公示的方式进行公告，不再单独通知用户。变更后的协议和规则一经公布后，立即自动生效。如用户不同意相关变更，应当立即停止使用admin_php付费应用。用户继续订阅或使用admin_php付费应用，即表示用户接受经修订的协议。
                                    <br>
                                </p>

                                <h3 class="mt16">二、应用下载</h3>
                                <p class="mt16">
                                    1、用户可以在admin_php官网在线下载admin_php应用。 <br>
                                    2、admin_php付费应用需要在注册登录且订阅后才可以下载安装使用。 <br>
                                </p>

                                <h3 class="mt16">三、应用使用</h3>
                                <p class="mt16">
                                    1、admin_php应用禁止在各类平台以任何形式（包括二次修改后）进行二次分发（出售）。<br>
                                    2、基于admin_php应用从事的一切商业行业和本站无关。<br>
                                    3、admin_php应用禁止分享、复制、转售和传播。<br>
                                    4、admin_php应用只支持中国大陆及港澳台地区安装使用。<br>
                                    5、admin_php付费应用务必正确录入授权主体信息后再进行使用。<br>
                                    6、用户不得利用admin_php应用制作、上载、复制、发布、传播如下法律、法规和政策禁止的内容：<br>
                                    (1) 反对宪法所确定的基本原则的；<br>
                                    ...
                                    如果用户违反相关上述相关使用条例，admin_php官网有权利收回用户订阅的付费应用和用户在admin_php官网注册的账号，如果有违反法律、法规和政策禁用的内容进行使用的，admin_php官网有权向公安机关举报并配合公安机关提供用户相关隐私个人信息。
                                </p>

                                <h3 class="mt16">四、应用更新</h3>
                                <p class="mt16">
                                    1、在更新admin_php应用到最新版本时，请做好当前应用版本的整站备份，admin_php不对应用更新升级造成的损失承担任何责任。<br>
                                    2、如因admin_php应用下架造成的应用无法更新，admin_php不承担任何责任。<br>
                                    3、如因admin_php应用开发商放弃更新应用造成的无法更新，admin_php不承担任何责任。<br>
                                </p>

                                <h3 class="mt16">五、应用价格</h3>
                                <p class="mt16">
                                    1、应用金额以最终结算价格为准，已售出的付费应用不做任何差价补偿。<br>
                                    2、如果利用系统漏洞或用户使用特殊手段以低价或免费的形式购买的应用，admin_php有权收回售出的应用。<br>
                                </p>

                                <h3 class="mt16">六、应用授权</h3>
                                <p class="mt16">
                                    1、admin_php付费应用可用于个人或企业自营网站应用，可用于外包开发，禁止二次转售应用源码。<br>
                                </p>

                                <h3 class="mt16">七、退款和转让</h3>
                                <p class="mt16">
                                    1、admin_php付费应用因提供全部源码，且源码可以拷贝，购买后不提供任何原因退款，请在购买前慎重考虑和仔细阅读此协议。<br>
                                    2、admin_php付费应用如果价格发生变动，此前购买的应用不提供任何的补偿或退款。<br>
                                    3、admin_php付费应用禁止以任何形式进行转让和出售。<br>
                                </p>

                                <h3 class="mt16">八、知识产权声明</h3>
                                <p class="mt16">
                                    1、admin_php应用源代码所有权和著作权归应用开发商所有。<br>
                                    2、除另有特别声明外，admin_php应用所依托的代码、文字、图片等著作权、专利权及其他知识产权均归其开发商所有。<br>
                                </p>

                                <h3 class="mt16">九、法律责任</h3>
                                <p class="mt16">
                                    1、如果admin_php官网发现或收到他人举报或投诉用户违反本协议约定的，admin_php官网有权不经通知随时对相关内容，包括但不限于用户资料、聊天记录进行审查、删除，并视情节轻重对违规帐号处以包括但不限于警告、帐号封禁、设备封禁、功能封禁的处罚。<br>
                                    2、用户理解并同意，admin_php官网有权依合理判断对违反有关法律法规或本协议规定的行为进行处罚，对违法违规的任何用户采取适当的法律行动，并依据法律法规保存有关信息向有关部门报告等，用户应承担由此而产生的一切法律责任。<br>
                                    3、用户理解并同意，因用户违反本协议约定，导致或产生的任何第三方主张的任何索赔、要求或损失，包括合理的律师费，用户应当赔偿admin_php官网与合作公司、关联公司，并使之免受损害。<br>
                                </p>

                                <h3 class="mt16">十、不可抗力及其他免责事由</h3>
                                <p class="mt16">
                                    1、用户理解并确认，在使用本服务的过程中，可能会遇到不可抗力等风险因素，使本服务发生中断。不可抗力是指不能预见、不能克服并不能避免且对一方或双方造成重大影响的客观事件，包括但不限于自然灾害如洪水、地震、瘟疫流行和风暴等以及社会事件如战争、动乱、政府行为等。出现上述情况时，admin_php官网将努力在第一时间与相关单位配合，及时进行修复，但是由此给用户或第三方造成的损失，admin_php官网及合作单位在法律允许的范围内免责。<br>
                                    ...
                                    3、用户理解并确认，本服务存在因不可抗力、计算机病毒或黑客攻击、系统不稳定、用户所在位置、用户关机以及其他任何技术、互联网络、通信线路原因等造成的服务中断或不能满足用户要求的风险，因此导致的用户或第三方任何损失，admin_php官网不承担任何责任。<br>
                                    4、用户理解并确认，在使用本服务过程中存在来自任何他人的包括误导性的、欺骗性的、威胁性的、诽谤性的、令人反感的或非法的信息，或侵犯他人权利的匿名或冒名的信息，以及伴随该等信息的行为，因此导致的用户或第三方的任何损失，admin_php官网不承担任何责任。<br>
                                    5、用户理解并确认，admin_php官网需要定期或不定期地对admin_php官网平台或相关的设备进行检修或者维护，如因此类情况而造成服务在合理时间内的中断，admin_php官网无需为此承担任何责任。<br>
                                    6、admin_php官网依据法律法规、本协议约定获得处理违法违规或违约内容的权利，该权利不构成admin_php官网的义务或承诺，admin_php官网不能保证及时发现违法违规或违约行为或进行相应处理。<br>
                                    7、用户理解并确认，对于admin_php官网向用户提供的下列产品或者服务的质量缺陷及其引发的任何损失，admin_php官网无需承担任何责任：<br>
                                    (1) admin_php官网向用户免费提供的服务；<br>
                                    (2) admin_php官网向用户赠送的任何产品或者服务。<br>
                                    8、在任何情况下，admin_php官网均不对任何间接性、后果性、惩罚性、偶然性、特殊性或刑罚性的损害，包括因用户使用admin_php官网或本服务而遭受的利润损失，承担责任（即使admin_php官网已被告知该等损失的可能性亦然）。尽管本协议中可能含有相悖的规定，admin_php官网对用户承担的全部责任，无论因何原因或何种行为方式，始终不超过用户因使用admin_php官网提供的服务而支付给admin_php官网的费用(如有)。<br>
                                </p>

                                <h3 class="mt16">十一、服务的变更、中断、终止</h3>
                                <p class="mt16">
                                    1、鉴于网络服务的特殊性，用户同意admin_php官网有权随时变更、中断或终止部分或全部的服务（包括收费服务）。admin_php官网变更、中断或终止的服务，admin_php官网应当在变更、中断或终止之前通知用户。<br>
                                    2、如发生下列任何一种情形，admin_php官网有权变更、中断或终止向用户提供的免费服务或收费服务，而无需对用户或任何第三方承担任何责任：<br>
                                ...
                                <p class="mt16">
                                    1、admin_php官网郑重提醒用户注意本协议中免除admin_php官网责任和限制用户权利的条款，请用户仔细阅读，自主考虑风险。未成年人应在法定监护人的陪同下阅读本协议。<br>
                                    2、本协议的效力、解释及纠纷的解决，适用于中华人民共和国法律。若用户和admin_php官网之间发生任何纠纷或争议，首先应友好协商解决，协商不成的，用户同意将纠纷或争议提交admin_php官网住所地有管辖权的人民法院管辖。<br>
                    ...
                    <?php if ($step == '2') { ?>
                        <div class="mounted-content-item show">
                            <div class="mounted-env-container">
                                ...
                                <div class="mounted-tips mt16">
                                    系统要求admin_php安装目录下的runtime和upload必须可写，才能使用admin_php的所有功能。
                                </div>
                                <div class="mounted-item mt16">
                                    <div class="content-header">
                                        目录权限监测
                            ...
                            <?php if ($step == '5') { ?>
                                <div class="show" id="mounting-success">
                                    ...
                                    <div class="success-content">
                                        ...
                                        <div style="margin-top: 10px;font-size:14px;color: #444444">版本号：1.0.0</div>
                                        <div class="tips">
    ...
    <?php else: ?>
        <script>
            var successTables = undefined;
            console.log('No success tables available.');
        </script>
    <?php endif; ?>
